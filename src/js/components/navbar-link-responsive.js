...
class NavbarLinkResponsive extends LitWithoutShadowDom {
  constructor() {
    super();
  ...
  render() {
    return html`
      ...
      >
        <li class="nav-item navbar-link-responsive">
        ...
        <li
          class="nav-item navbar-link-responsive dropdown d-none"
          id="userLoggedMenu"
        >
          <a
        ...
        <li class="nav-item navbar-link-responsive" id="loginMenu">
...
customElements.define('navbar-link-resposive', NavbarLinkResponsive);
